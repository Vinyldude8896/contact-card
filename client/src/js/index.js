...
// import database
import { initdb, getDb, postDb, editDb, deleteDb } from './database';
...
window.editCard = (e) => {
  // grabs the id from the button element attached to the contact card and sets a golbal variable that will be used in the form element.
